    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4 sm:flex-row justify-between">
          <TextInput type='text' placeholder='Title' id='text' className='flex-1' onChange={(e) => setFormData({...formData,title: e.target.value})}/>
        ...
        <Button type='submit' gradientDuoTone={'tealToLime'} disabled={imageUploadProgress}>
          {imageUploadProgress ? "Image is uploading..." : "Publish"}
        </Button>
