    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4 sm:flex-row justify-between">
          <TextInput type='text' placeholder='Title' id='text' className='flex-1'  onChange={(e) => setFormData({...formData,title: e.target.value})}   value={formData.title}/>
        ...
        {formData && (
         ...
         < img className="h-auto max-w-full" src={formData.image} />
        )}
        ...
        <Button type='submit' gradientDuoTone={'tealToLime'} disabled={imageUploadProgress}>
          {imageUploadProgress ? "Image is uploading..." : "Update"}
        </Button>
