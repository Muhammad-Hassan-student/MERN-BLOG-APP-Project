      ...
      <div className="flex-1">
        ...
        {isEditing ? (
          ...
          <div className="flex justify-end gap-2 text-xs">
            <Button gradientDuoTone={'greenToBlue'} type="button" size={'sm'} onClick={handleSave}>Save</Button>
            <Button gradientDuoTone={'pinkToOrange'} size={'sm'} outline onClick={() => setIsEditing(false)}>Cancel</Button>
          </div>
          </>
        ) : (
          <>
